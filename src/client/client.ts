...
create_object(0.5, 'img/mercury.jpeg', 7.5)      //mercury=elements[1]
create_object(0.8, 'img/venus.jpg', 10.8)       //venus=elements[2]
create_object(1.5, 'img/earth.jpeg', 16.1)       //earth=elements[3]
create_object(1, 'img/mars.jpeg', 21.6)          //mars=elements[4]
create_object(2.5, 'img/jupiter.jpg', 26.6)     //jupiter=elements[5]
create_object(2, 'img/saturn.jpeg', 34.1)        //saturn=elements[6]
create_object(1.8, 'img/uranus.jpeg', 40.1)       //uranus=elements[7]
...
const sat_ring_mat = new THREE.MeshBasicMaterial({ side: THREE.DoubleSide, map: new THREE.TextureLoader().load('img/saturnring.png') })
